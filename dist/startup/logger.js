...
var winstonLogger = winston_1.default.createLogger({
    ...
    transports: [
        ...
        new winston_1.transports.File({ filename: path_1.default.join(__dirname, "../logfile.log") }),
    ],
    exitOnError: false,
});
winstonLogger.exceptions.handle(new winston_1.transports.File({ filename: path_1.default.join(__dirname, "../exceptions.log"), level: "error" }));
